    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mt-2 text-gray-400">
              Generación inteligente de derechos de petición
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white">Derechos de Petición</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">Planes Premium</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">Consultoría Legal</a></li>
            </ul>
          </div>
        ...
        <div className="mt-8 border-t border-gray-800 pt-8 flex justify-between items-center">
          <p className="text-gray-400">&copy; 2025 LegalAI. Todos los derechos reservados.</p>
